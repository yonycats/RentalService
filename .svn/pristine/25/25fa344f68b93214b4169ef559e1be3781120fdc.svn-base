...
public class SearchVO {
	...
	public SearchVO(String cateId, String itemId, String comName, String itemName, String itemModel, Date itemDate,
			String itemMake, int itemCnt, int itemM12, int itemM36, int itemM60, String itemAttr, String itemAs,
			String itemDel, int fileType, String streFileNm, String fileExtsn) {
		super();
		this.cateId = cateId;
		this.itemId = itemId;
	...
	public void setComId(String comName) {
		this.comName = comName;
	}
