...
<main id="container" class="col-sm-12 mypage-main" >
   ...
   <div class="mypage-main-top" style="padding-top: 200px">
...
%>		
	...
	<tr align="center">
		<td colspan="7"><button><a href="<%=request.getContextPath() %>/partnership/insert.do">제휴문의 등록</a></button></td>
	</tr>
...
%>
<script>
	swal("성공!", "제휴문의 등록이 완료되었습니다.", 'success');
</script>
<%
	}
%>
