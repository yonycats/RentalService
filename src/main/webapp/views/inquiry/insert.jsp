...
<body>
	...
	<a href="<%=request.getContextPath()%>/inquiry/list.do">취소</a>

	<main>
		<div class="title">
			<h2 id="title">문의 게시판</h2>
		</div>
		...
		<input id="move_write_after" name="move_write_after" value="https://rentalfriend.co.kr/board/product/list.html?board_no=6" type="hidden"  />
		...
		<input id="8d8d343114c3ed5dd028052f76537" name="8d8d343114c3ed5dd028052f76537" value="2743fe3c17e213ec4d18a73f2a3aa089" type="hidden"  />
		<input id="fix_title_form_0" name="fix_title_form_0" value="배송문의 드립니다." type="hidden"  />
		<input id="bulletin_type" name="bulletin_type" value="title" type="hidden"  />

		<input id="fix_content_0" name="fix_content_0" value="■ 계약자 성함&lt;br /&gt;
		<!-- -&gt;&lt;br /&gt; -->
		<!-- &lt;br /&gt; -->
		<!-- ■ 계약자 휴대전화 번호&lt;br /&gt; -->
		<!-- -&gt;&lt;br /&gt; -->
		<!-- &lt;br /&gt; -->
		<!-- ■ 렌탈 신청한 상품명(예: 삼성에어컨)&lt;br /&gt; -->
		<!-- -&gt;&lt;br /&gt; -->
		<!-- &lt;br /&gt; -->
		<!-- " type="hidden"  /> -->


		<input id="fix_add_content" name="fix_add_content" value="" type="hidden"  /><div class="xans-element- xans-board xans-board-write-4 xans-board-write xans-board-4">
		상품정보선택
		<div class="prdSelect  ">
		            <p class="prdThumb"><a href="/product/detail.html?product_no=0"><img id="iPrdImg" src="//rentalfriend.co.kr/web/product/tiny/" onerror="this.src='//img.echosting.cafe24.com/skin/base_ko_KR/board/img_no.gif'" alt=""/></a></p>
		            <div class="prdInfo">
		                <p class="ico"><span id="sPrdCommonImg">    </span></p>
		                <h3><a href="/product/detail.html?product_no=0" id="aPrdNameLink"><span id="sPrdName"></span></a></h3>
		                <p class="price"><span id="sPrdPrice"></span></p>
		                <p class="button">
		                    <span id="iPrdView" class=""><a href="/product/detail.html?product_no=0" id="aPrdLink" target="_blank"><img src="//img.echosting.cafe24.com/skin/base_ko_KR/board/btn_prd_detail.gif" alt="상품상세보기"/></a></span>
		...
		<div class="boardWrite ">
			<table border="1" summary="">
				...
				<tbody>
					<tr class="first">
						<th scope="row">제목</th>
						<td><select id="select" name="select" fw-filter="isFill"
							fw-label="제목" fw-msg="">
								<option value="상품문의 드립니다.">상품문의 드립니다.</option>
								<option value="사용문의 드립니다.">사용문의 드립니다.</option>
						</select></td>
					</tr>
					<tr class="">
						<th scope="row">작성자</th>
						<td><input id="writer" name="writer" fw-filter="isFill"
							...
							maxLength="50" value="" type="text" /></td>
					</tr>
					...
					<tr>
						<td colspan="2" class="write">
							<!-- CSS -->
							<link rel="stylesheet"
								href="//img.echosting.cafe24.com/editors/froala/3.2.2/css/froala_editor.pkgd.min.css?vs=2407101325">
							<link rel="stylesheet"
								href="//img.echosting.cafe24.com/editors/froala/css/themes/ec_froala.css?vs=2407101325">

							<!-- HTML --> <textarea style="width: 100%;" name="content"
								id="content" class="ec-fr-never-be-duplicated"></textarea> <input
							type="hidden" id="content_hidden" fw-filter="isSimplexEditorFill"
							fw-label="내용" value="EC_FROALA_INSTANCE" /> <!-- JavaScript -->
							<script type="text/javascript"
								src="//img.echosting.cafe24.com/editors/froala/js/polyfill.min.js?vs=2407101325"></script>
							<script type="text/javascript"
								src="//img.echosting.cafe24.com/editors/froala/3.2.2/js/froala_editor.pkgd.min.js?vs=2407101325"></script>
							<script type="text/javascript"
								src="//img.echosting.cafe24.com/editors/froala/js/i18n/ko_KR.js?vs=2407101325"></script>

							<script>
								if (FroalaEditor.PLUGINS
										&& FroalaEditor.PLUGINS.url)
									delete FroalaEditor.PLUGINS.url; // ECHOSTING-518735
							</script> <!-- Run Froala Script --> <script>
													...
													(function() {
														...
														try {
															var o = {
																...
																"iframeStyleFiles" : [ "\/\/img.echosting.cafe24.com\/editors\/froala\/css\/froala_style.min.css?vs=2407101325" ],
																"heightMin" : 400,
																"language" : "ko_KR",
															...
															EC_FROALA_INSTANCE = new FroalaEditor(
																	...
																	function() {
																		...
																		script.src = "//img.echosting.cafe24.com/editors/froala/js/polyfill.min.js?vs=2407101325";
																		this.$iframe
													...
													function getFroalaResetCSS() {
														return "//img.echosting.cafe24.com/editors/froala/css/froala_editor_reset.css?vs=2407101325;"
													}

													//플로알라 front style CSS 가져오기
													function getFroalaStyleCSS() {
														return "//img.echosting.cafe24.com/editors/froala/css/froala_style.min.css?vs=2407101325";
													}

													//플로알라 front style EC CSS 가져오기
													function getFroalaECStyleCSS() {
														return "//img.echosting.cafe24.com/editors/froala/css/froala_style_ec.min.css?vs=2407101325";
													}
