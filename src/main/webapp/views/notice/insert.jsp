...
<form action="<%=request.getContextPath() %>/notice/insert.do" method="post" enctype="form-data">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                  ...
                                  <button type="submit" name="btn1" class="btn btn-primary" value="공지사항 등록">공지사항 등록</button>
                        </div>
                    </div>
